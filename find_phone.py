...
# Command: python find_phone.py ~/find_phone_test_images/51.jpg
# Input: 1 image
# Output: predicted x,y-coordinates (normalized) centered on phone
...
def predict_phone_position(image_dir, model):
    ...
    contours, hierarchy = cv2.findContours(heatmap, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
